/* PixelSwap -- ES module port of static/pixelswap.js.
 *
 * Same technique as before (the reactbits.dev pixel-swap effect, done with
 * DOM cloning plus the Web Animations API); the only change is the wrapper.
 * It stays framework-free because it manipulates a subtree React does not
 * own -- see components/PixelHeadline.jsx, which hands it one empty div and
